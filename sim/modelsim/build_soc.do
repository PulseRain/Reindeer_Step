...
vlog -work work +incdir+$common +incdir+$config ../../submodules/PulseRain_MCU/submodules/PulseRain_processor_core/source/mul_div/long_slow_div_denom_reg.v
...
vlog -work work +incdir+$common +incdir+$config ../../submodules/PulseRain_MCU/memory/dram_rw_buffer.v
...
vlog -work work +incdir+$common +incdir+$config ../../submodules/PulseRain_MCU/submodules/PulseRain_processor_core/source/Reindeer_machine_timer.v
...
vlog -work work +incdir+$common +incdir+$config ../../submodules/HW_Loader/source/debug_reply.v
vlog -work work +incdir+$common +incdir+$config ../../submodules/HW_Loader/source/debug_UART.v
vlog -work work +incdir+$common +incdir+$config ../../submodules/HW_Loader/source/Serial_RS232.v
