...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/sdram_ISSI_SDRAM.v"                -work ISSI_SDRAM     -cdslib ./cds_libs/ISSI_SDRAM.cds.lib    
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/sdram_ISSI_SDRAM_test_component.v" -work ISSI_SDRAM     -cdslib ./cds_libs/ISSI_SDRAM.cds.lib    
